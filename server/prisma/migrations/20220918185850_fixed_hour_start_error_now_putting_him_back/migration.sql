...
INSERT INTO "new_Ad" ("createdAt", "gameId", "hourEnd", "id", "name", "useVoiceChannel", "weekDays", "yearsPlaying") SELECT "createdAt", "gameId", "hourEnd", "id", "name", "useVoiceChannel", "weekDays", "yearsPlaying" FROM "Ad";
DROP TABLE "Ad";
